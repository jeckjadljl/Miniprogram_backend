...
module.exports = app => {
  ...
  Merchant.associate = function () {
    const { Order, GoodsCategory, Goods } = model;
    Merchant.hasMany(Order, { foreignKey: "orgUuid" });
    Merchant.hasMany(GoodsCategory, { foreignKey: "orgUuid" });
    Merchant.hasMany(Goods, { foreignKey: "orgUuid" });
  };
